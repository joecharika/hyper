...
class Cookie
{
     ...
     * @return bool
     */
    function addCookie(string $cookieName, string $cookieValue, $expire = null, $path = "/", $domain = null, $secure = true, $httponly = false)
    {
        return setcookie($cookieName, $_SESSION[$cookieName] = $cookieValue, $expire ?? time() + 60 * 60 * 24 * 1, $path, $domain ?? Request::host(), $secure, $httponly);
    }
    ...
    {
        return Arr::key($_COOKIE, $cookie_name, @$_SESSION[$cookie_name]);
    }
